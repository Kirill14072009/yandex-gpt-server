...
ВАЖНО: НЕ пиши название места в ответе. Название уже показано. Начни сразу с описания.

ОПРЕДЕЛИ ТИП МЕСТА (одно-два слова): Памятник, Бюст, Мемориальная доска, Парк, Сквер, Музей, Собор, Церковь, Часовня, Театр, Библиотека, Мост, Фонтан.

Напиши 2-3 предложения:
- Если памятник/бюст — КОМУ посвящён, когда установлен.
- Если часовня/церковь — когда построена, в честь чего.
- Если музей — чему посвящён.
