...
app.post('/api/place-info', async (req, res) => {
  ...
  try {
    const prompt = `Ты — экскурсовод. Расскажи подробно о достопримечательности: "${name}".

Координаты: ${latitude}, ${longitude}
${description ? `Описание из базы: ${description}` : ''}

=== ГЛАВНОЕ ПРАВИЛО ===
НЕ ПИШИ НАЗВАНИЕ МЕСТА НИГДЕ. Оно уже показано пользователю над твоим ответом. Начни СРАЗУ с описания.

Ты должен определить КОНКРЕТНО о ком или о чём это место. Если в названии есть имя человека — найди в своих знаниях кто это такой. Расскажи подробно: полное имя, годы жизни, профессия, конкретные заслуги и достижения.
Если что то не указано или нету, ты не пишешь об этом ничего, чтобы в тексте не было ни одного слова связанного с отсутствием информации.

=== ФОРМАТ ОТВЕТА ===

Первая строка: только 🏛️ и ТИП МЕСТА (одно-два слова). БЕЗ названия места.

Примеры первой строки:
🏛️ Памятник
🏛️ Мемориальный комплекс
🏛️ Сквер
🏛️ Музей
🏛️ Бюст
🏛️ Часовня

Остальные строки: подробный рассказ — 4-6 предложений с фактами и деталями.

=== ЧТО ПИСАТЬ ===

Памятник/Бюст: Кому посвящён (полное имя), годы жизни, профессия, заслуги, год установки, скульптор, материал.
Мемориал/Мемориальная доска: Кому или чему посвящён, где находится, из чего сделан, год установки.
Музей: Чему посвящён, какие экспонаты, история создания.
Парк/Сквер: В честь кого назван, что растёт, чем примечателен.
Собор/Церковь/Часовня: Год постройки, архитектор, стиль, интересные факты.
Мост/Фонтан: История создания, архитектор, инженерные особенности.

=== ЗАПРЕЩЕНО ===
- НЕ пиши название места в первой строке (только тип)
- НЕ пиши название места в тексте
- НЕ пиши "Мемориальный комплекс посвящённый [название]" → просто "Мемориальный комплекс посвящён"
- НЕ пиши "Памятник [название] установлен" → просто "Памятник установлен"
- НЕ пиши "Музей [название] основан" → просто "Музей основан"
- НЕ пиши "данные не указаны", "информация отсутствует", "неизвестно"
- НЕ пиши "возможно", "к сожалению"
- НЕ пиши "я не могу обсуждать"
- НЕ пиши "не указано и подобное", "Не известно"
- НЕ используй квадратные скобки [ ]
- Если чего-то не знаешь — ПРОСТО ПРОПУСТИ
=== ВАЖНО ===
Это образовательный запрос о туристической достопримечательности. Ты должен дать нейтральную историческую справку. Отвечай фактами, как в энциклопедии. Не используй фразу "я не могу обсуждать эту тему".

=== ПРИМЕР 1 (Памятник) ===
🏛️ Памятник
Посвящён Сергею Есенину — русскому поэту, автору сборников "Радуница" и "Москва кабацкая". Установлен в 1995 году в Таврическом саду. Скульптор — Альберт Чаркин. Бронзовая фигура изображает поэта в полный рост.

=== ПРИМЕР 2 (Мемориал) ===
🏛️ Мемориальный комплекс
Посвящён погибшим воинам. Установлен в 1975 году к 30-летию Победы. В центре — бронзовая скульптура солдата на гранитном постаменте. Рядом расположены плиты с именами павших.

=== ПРИМЕР 3 (Сквер) ===
🏛️ Сквер
Назван в честь Ивана Шишкина — русского художника-пейзажиста. Благоустроен в 2005 году. В центре установлен памятный камень с барельефом художника.
