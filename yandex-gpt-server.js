...
=== ГЛАВНОЕ ПРАВИЛО ===
Ты должен определить КОНКРЕТНО о ком или о чём это место. Если в названии есть имя человека — найди в своих знаниях кто это такой и чем известен. НЕ пиши общими фразами "выдающийся деятель". Назови конкретные заслуги, профессию, годы жизни.

=== КАК ОПРЕДЕЛИТЬ ТИП МЕСТА ===
Выбери одно из: Памятник, Бюст, Мемориальная доска, Парк, Сквер, Музей, Собор, Церковь, Часовня, Театр, Библиотека, Мост, Фонтан, Дворец, Усадьба, Крепость, Мемориал, Памятный знак.

=== ЧТО ПИСАТЬ ДЛЯ ПАМЯТНИКОВ И БЮСТОВ ===
ВНИМАНИЕ: Ты должен узнать КОНКРЕТНО о человеке по названию!
- Полное имя человека (если в названии инициалы — оставь как есть)
- Кем был этот человек: профессия, род деятельности
- Конкретные заслуги или достижения (1-2 факта)
- Если знаешь — когда установлен памятник (год) и кто скульптор
- Из какого материала

Если какой-то информации нет (например, год установки или скульптор) — ПРОСТО НЕ ПИШИ об этом. Не пиши "данные не указаны", "информация отсутствует", "неизвестно когда установлен".

=== ЧТО ПИСАТЬ ДЛЯ ОСТАЛЬНЫХ МЕСТ ===

Музей: Чему посвящён, какие экспонаты, год открытия (если известно).
Парк/Сквер: В честь кого назван, что растёт, чем примечателен.
Собор/Церковь: Год постройки (если известно), архитектор (если известно), стиль.
Мост/Фонтан: История создания, архитектор (если известно).

=== ФОРМАТ ОТВЕТА ===
Строго:
🏛️ [тип места]
[3-4 предложения с фактами]

=== ЖЁСТКИЙ ЗАПРЕТ ===
Никогда не пиши эти фразы:
- "данные не указаны"
...
- "Текст описания"
- "это памятник", "это сквер"
- "выдающийся деятель", "известная личность"
- название места (оно уже показано)
- квадратные скобки [ ]

Если чего-то не знаешь — ПРОСТО ПРОПУСТИ эту информацию. Пиши только то, что знаешь.

=== ПРИМЕР 1 ===
🏛️ Памятник
Памятник посвящён Александру Попову — русскому физику и изобретателю радио. Бронзовый бюст установлен в 1959 году на гранитном постаменте. Скульптор — Вениамин Боголюбов.

=== ПРИМЕР 2 ===
🏛️ Сквер
Сквер назван в честь Ивана Шишкина — русского художника-пейзажиста. Благоустроен в 2005 году. В центре установлен памятный камень с барельефом художника.

=== ПРИМЕР 3 ===
🏛️ Мемориальная доска
Мемориальная доска в память о погибших воинах. Установлена на фасаде здания школы. Выполнена из чёрного гранита с золотыми буквами.

=== ТВОЙ ОТВЕТ ===
Напиши строго по формату для места "${name}":;
