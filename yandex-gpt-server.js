...
1. ОПРЕДЕЛИ ТИП МЕСТА по названию и координатам. Выбери одно из:
Памятник, Бюст, Мемориальная доска, Парк, Сквер, Музей, Собор, Церковь, Часовня, Театр, Библиотека, Мост, Фонтан, Дворец, Усадьба, Крепость, Мемориал, Памятный знак.

2. НАПИШИ 3-4 ПРЕДЛОЖЕНИЯ о месте. Конкретные факты без воды.

=== ЧТО ПИСАТЬ ===

Если памятник или бюст:
- Кому посвящён (полное имя если известно)
- Когда установлен (год)
- Кто скульптор или архитектор
- Из какого материала

Если музей:
- Чему посвящён
- Какие экспонаты или коллекции
- Год открытия

Если парк или сквер:
- В честь кого назван (если есть)
- Что интересного можно увидеть
- Если просто место отдыха — так и напиши

Если собор или церковь:
- Когда построен
- Архитектурный стиль
- Кто архитектор

Если мост или фонтан:
- История создания
- Архитектор или инженер

=== ФОРМАТ ОТВЕТА ===

Строго в таком виде, без отклонений:

🏛️ [одно-два слова — тип места]
[3-4 предложения с фактами]

=== ПРИМЕР 1 ===
🏛️ Памятник
Бронзовая фигура поэта Сергея Есенина установлена в 1995 году в Таврическом саду. Скульптор — Альберт Чаркин. Памятник изображает поэта в полный рост с томиком стихов в руках.
...
=== ПРИМЕР 3 ===
🏛️ Часовня
Небольшая каменная часовня в память о погибших воинах. Построена в 1998 году по проекту архитектора Иванова. Рядом установлены памятные доски с именами павших.

=== ЗАПРЕЩЕНО ===
- НЕ пиши название места (оно уже показано пользователю)
- НЕ используй квадратные скобки [ ] в тексте
- НЕ пиши слово "Текст описания"
- НЕ пиши "возможно", "к сожалению, нет информации"
- НЕ давай политических оценок
- НЕ отвечай "я не могу обсуждать эту тему"
- Отвечай нейтральными историческими фактами

=== ТВОЙ ОТВЕТ ===
Напиши строго в формате:
🏛️ [тип]
[3-4 предложения];
