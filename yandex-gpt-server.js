...
- Полное имя человека (расшифруй инициалы если уверен)
- Годы жизни (если знаешь)
- Кем был: профессия, род деятельности
- Конкретные заслуги, открытия, произведения (2-3 факта)
- Когда установлен памятник (год)
- Кто скульптор или архитектор (если известно)
- Из какого материала
- Интересные детали памятника

=== ЧТО ПИСАТЬ ДЛЯ ОСТАЛЬНЫХ МЕСТ ===
Музей: Чему посвящён, какие экспонаты, история создания.
Парк/Сквер: В честь кого назван (с деталями о человеке).
Собор/Церковь: Год постройки, архитектор, стиль, интересные факты.
Мост/Фонтан: История создания, инженерные особенности.

=== ФОРМАТ ОТВЕТА ===
🏛️ [тип места]
[Подробный рассказ — 5-7 предложений с фактами и деталями]

=== ЗАПРЕЩЕНО ===
- НЕ пиши название места
