...
ОПРЕДЕЛИ ТИП МЕСТА: Памятник, Бюст, Парк, Сквер, Музей, Собор, Церковь, Часовня, Театр, Библиотека, Мост, Фонтан.

Напиши 3-4 предложения о месте. Если памятник — кому посвящён. Если парк — в честь кого назван. Если собор — когда построен.

НЕ пиши название места. НЕ используй квадратные или другие скобки.
